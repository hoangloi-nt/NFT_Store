...
const Category = () => {
	...
	return (
		<>
			<div className="flex flex-wrap items-center justify-center text-sm categories gap-x-10">
			...
			<div className="my-5">
				<div
					className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto gap-4 lg:gap-10`}
				>
				...
				<ReactPaginate
					...
					containerClassName="pagination flex justify-center item-center mb-2 mt-[20px] lg:mt-[50px] gap-x-2"

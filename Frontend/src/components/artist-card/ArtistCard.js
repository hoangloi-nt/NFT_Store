	...
	return (
		<div className="flip-card">
			<div className="flip-card-inner">
				<div className="front">
					<div className="mx-auto card w-[190px] h-[250px] md:w-[240px] md:h-[300px] lg:w-[280px]  lg:h-[323px] bg-[#869BDF] bg-opacity-[15%] border border-[#535488] border-opacity-40 rounded-lg hover:-translate-y-1 transition-all flex flex-col justify-center items-center gap-y-10">
						<img
							src={
								avatar ||
				...
				<div className="back">
					<div className="card mx-auto w-[190px] h-[250px] md:w-[240px] md:h-[300px] lg:w-[280px]  lg:h-[323px] bg-[#869BDF] bg-opacity-[15%] border border-[#535488] border-opacity-40 rounded-lg hover:-translate-y-1 transition-all flex flex-col justify-center items-center gap-y-5">
						<img
							src={
								avatar ||
								"https://img.freepik.com/free-vector/vector-illustration-mountain-landscape_1441-71.jpg"

...
const Search = () => {
	...
	return (
		<div>
			...
			>
				<div className="header-search rounded-sm relative flex items-center mx-5 bg-background border border-white lg:w-[300px]">
					<input
						ref={inputRef}
						value={searchValue}
						type="text"
						...
						spellCheck={false}
						className="flex-1 h-full py-3 pl-3 bg-transparent lg:pr-10 "

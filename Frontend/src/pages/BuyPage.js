  ...
  return (
    <BuyPageStyled>
      ...
      <div className="container ">
        ...
        <div className="flex flex-col justify-center my-8 lg:my-4">
          <div className="mb-6 ml-2 text-left lg:ml-0 heading-text">
            {t("buyPage.more")}
          </div>
          ...
          {listProductData.length > 8 ? (
            <NavLink className={"text-right mt-7"} to={`/artist/${creatorId}`}>
              {t("buyPage.viewAll")}
            </NavLink>
          ) : (
            <></>
